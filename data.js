window.WHF_DATA = {
  ...
  "latestUpdate": {
    "title": "White Hawks Move to 2–0 with Win Over Watertown!",
    "summary": "WHF defeated Watertown to remain undefeated in dual meets and improve its season record to 2–0.",
    "body": "The White Hawks earned another team victory over Watertown and are now 2–0 in dual meets this season. Congratulations to all of our swimmers and divers!",
  ...
  "previousLatestUpdate": {
    ...
    "summary": "WHF celebrated its renovated home pool with a strong showing against Dassel-Cokato, including relay wins, event sweeps, and school and pool diving records for Bailey Monette. Read Samantha Dongoske’s recap in White Hawks News.",
    "author": "Samantha Dongoske",
    "updated": "September 14, 2026",
    "actionText": "Read Article on White Hawks News",
    "linkUrl": "https://whs.westonka.k12.mn.us/activities/white-hawks-news/sports-article/~board/white-hawks-news/post/whf-girls-swim-dive-rolls-out-the-red-with-dominant-performance"
  },
  "weeklyUpdate": {
  ...
  "boosterCards": [
    {
      "accent": "split",
      "title": "Booster Fee",
      "body": "$175 — unchanged from last year."
    },
    {
      "accent": "green",
      "title": "Leadership Update",
      "body": "Tammy Johnson will continue serving as Treasurer through the conclusion of this season at her request."
    },
    {
      "accent": "red",
      "title": "Bylaw Updates",
      "body": "The President and Vice President will continue serving until the conclusion of their athlete’s senior year so the current leadership team can fulfill the timing equipment commitment before transitioning roles."
    },
    {
      "accent": "green",
      "title": "Open After Season",
      "body": "At the conclusion of this season, Treasurer, Secretary, and Volunteer Coordinator will be open for election."
    },
    {
      "accent": "red",
      "title": "Volunteers Matter",
      "body": "Timing, concessions, hospitality, admissions, fundraising, and behind-the-scenes roles all make a difference."
    }
  ],
  "sponsorIntro": {
  ...
  "seasonRecord": {
    "value": "2-0",
    "note": "WHF is now 2-0 in dual meets after defeating Watertown."
  },
  "programHighlights": [],
  "photoLinks": [],
